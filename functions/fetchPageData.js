...
export function fetchHackthenorthData() {
  return [
    ...
    "3. *Delegation of tasks*. Once the above has been sorted out, the frontend team gets to work. There really isn’t a special way we divvy up our tasks—we simply slice the site into equal pieces of work, then assign frontend developers to each respective piece. *Note: this method of delegation works because each individual frontend dev is super capable and passionate about the project itself. I would NOT recommend this strategy with a traditional set of developers.*",
    "**The Work**",
