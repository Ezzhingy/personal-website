export function fetchEthglobalData() {
  return [
    ...
    "/ethglobal-tag.jpeg",
    "Enough emotional mumbo jumbo though—let’s talk about what happened after that dream came true. My ETHGlobal experience was nothing short of transformative. ETHGlobal is a web3 events startup made possible by 20 passionate people. As a 20-person startup, everyone has a big part to play, including the interns. I thought my time at Faire was impactful, but ETHGlobal takes autonomy to another level. From day one, I was shipping code alongside the rest of the engineering team. Everyone on the engineering team is treated as equals, regardless of their prior experience. For example, in my first week, I had the chance to revamp the OTP auth system, modify the user database schema, and write OpenAI classification scripts. I got more work done that week than I ever had for any other internship combined.",
    "**Core Values**",
