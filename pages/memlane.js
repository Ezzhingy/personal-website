...
export default function memlane({ data }) {
  ...
  return (
    <div className="max-w-2xl mx-auto pt-10 text-darkBg dark:text-lightBg">
      <Seo
        title="Memlane | Eugene Zhang"
        desc="A mobile app to help you discover and relive memories where they were made."
        keywords="memlane, mobile app, react native, expo, firebase, google cloud, firestore, storage, authentication, react navigation, memories, social media"
        path="/memlane"
      />
